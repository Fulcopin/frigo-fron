  ...
  const bodyElements = [
    ...
    // ── Tabla Principal de Monitoreo ──
    {
      ...
      columns: [
        ...
        { label: "Desafío c/hora con esferas: 3mm Fe, 3mm NoFe, 4mm SS - ¿Exitoso?", type: "select", required: false, options: ["SI", "NO"], apiMap: "", apiEndpoint: "", formula: "", group: "Desafío" },
      ...
      predefinedRows: [
        ...
        { "HORA": "", "LOTE": "", "Clasificación": "", "Todos los productos pasaron a través del detector de metal plenamente funcionando": "", "Algún fragmento de metal es detectado en el producto que pasó a través del detector de metales": "", "Desafío c/hora con esferas: 3mm Fe, 3mm NoFe, 4mm SS - ¿Exitoso?": "", "OBSERVACIONES": "", _rowSpan: {}, _hidden: {} },
        { "HORA": "DESAFÍO CON ESFERAS", "LOTE": "-", "Clasificación": "", "Todos los productos pasaron a través del detector de metal plenamente funcionando": "-", "Algún fragmento de metal es detectado en el producto que pasó a través del detector de metales": "-", "Desafío c/hora con esferas: 3mm Fe, 3mm NoFe, 4mm SS - ¿Exitoso?": "", "OBSERVACIONES": "", _rowSpan: {}, _hidden: {} },
        { "HORA": "", "LOTE": "", "Clasificación": "", "Todos los productos pasaron a través del detector de metal plenamente funcionando": "", "Algún fragmento de metal es detectado en el producto que pasó a través del detector de metales": "", "Desafío c/hora con esferas: 3mm Fe, 3mm NoFe, 4mm SS - ¿Exitoso?": "", "OBSERVACIONES": "", _rowSpan: {}, _hidden: {} },
        { "HORA": "DESAFÍO CON ESFERAS", "LOTE": "-", "Clasificación": "", "Todos los productos pasaron a través del detector de metal plenamente funcionando": "-", "Algún fragmento de metal es detectado en el producto que pasó a través del detector de metales": "-", "Desafío c/hora con esferas: 3mm Fe, 3mm NoFe, 4mm SS - ¿Exitoso?": "", "OBSERVACIONES": "", _rowSpan: {}, _hidden: {} },
        { "HORA": "", "LOTE": "", "Clasificación": "", "Todos los productos pasaron a través del detector de metal plenamente funcionando": "", "Algún fragmento de metal es detectado en el producto que pasó a través del detector de metales": "", "Desafío c/hora con esferas: 3mm Fe, 3mm NoFe, 4mm SS - ¿Exitoso?": "", "OBSERVACIONES": "", _rowSpan: {}, _hidden: {} },
        { "HORA": "DESAFÍO CON ESFERAS", "LOTE": "-", "Clasificación": "", "Todos los productos pasaron a través del detector de metal plenamente funcionando": "-", "Algún fragmento de metal es detectado en el producto que pasó a través del detector de metales": "-", "Desafío c/hora con esferas: 3mm Fe, 3mm NoFe, 4mm SS - ¿Exitoso?": "", "OBSERVACIONES": "", _rowSpan: {}, _hidden: {} },
  ...
  const bodyElements = [
    ...
    // Resumen Totales Porciones
    {
      ...
      fields: [
        ...
        { label: "PESO NETO CAJA (LBS)", type: "calculated", required: false, options: [], apiMap: "", apiEndpoint: "", formula: "[Sumatoria Pesos Netos (LBS)]" },
    ...
    // CONTENIDO POR BOLSA MASTER
    {
      ...
      predefinedRows: [
        { "Métrica": "Coef. Unif.", "B. 1": "", "B. 2": "", "B. 3": "", "B. 4": "", "B. 5": "", "B. 6": "", "B. 7": "", "B. 8": "", "B. 9": "", "B. 10": "", _rowSpan: {}, _hidden: {} },
        { "Métrica": "P. Bruto Bolsa (lbs)", "B. 1": "", "B. 2": "", "B. 3": "", "B. 4": "", "B. 5": "", "B. 6": "", "B. 7": "", "B. 8": "", "B. 9": "", "B. 10": "", _rowSpan: {}, _hidden: {} },
        { "Métrica": "P. Neto Bolsa (lbs)", "B. 1": "", "B. 2": "", "B. 3": "", "B. 4": "", "B. 5": "", "B. 6": "", "B. 7": "", "B. 8": "", "B. 9": "", "B. 10": "", _rowSpan: {}, _hidden: {} },
      ],
    },
